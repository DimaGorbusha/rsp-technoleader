...
class Logger():
    ...
    def log_service(self, message: str) -> None:
        """
        Вносит в логи время отправки запроса и адрес получателя
        Данные о получателе вносятся ВРУЧНУЮ
        """
        self.sent_logger.info(message)